...
class Coupled_Neural_Network(Neural_Network_Base_Class):
    def __init__(self):
        ...
        self.num_input_nodes = 12
        self.num_output_nodes = 32
        self.linear1_1 = nn.Linear(8, 8)
        self.linear2_1 = nn.Linear(8, 8)
        self.linear3_1 = nn.Linear(8, 8)

        self.linear1_2 = nn.Linear(4, 4)
        self.linear2_2 = nn.Linear(4, 4)
        self.linear3_2 = nn.Linear(4, 4)

        self.linear1 = nn.Linear(12, 2**5)
...
if __name__ == '__main__':
    ...
    datasets_train, datasets_val = model.prepare_training_data(training_inputs, training_solutions, inputs_for_NN = "probability_for_each_state", split_indices=[[0,1,2], [3,4]])  # inputs for NN eiter register_probability_repeat or probability_for_each_state
