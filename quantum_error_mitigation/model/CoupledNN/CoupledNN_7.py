...
class Coupled_Neural_Network(Neural_Network_Base_Class):
    def __init__(self):
        ...
        self.num_input_nodes = 128
        self.num_output_nodes = 128
        self.linear1_1 = nn.Linear(16, 16)
        self.linear2_1 = nn.Linear(16, 16)
        self.linear3_1 = nn.Linear(16, 16)

        self.linear1_2 = nn.Linear(8, 8)
        self.linear2_2 = nn.Linear(8, 8)
        self.linear3_2 = nn.Linear(8, 8)

        self.linear1 = nn.Linear(24, 2**7)
    ...
    def generate_mitigation_service_request(self, counts, cm_gen_method):
        ...
        request = {
          ...
          "counts": counts,
          "shots": self.shots,
          "qubits": [0,1,2,3,4,5,6],  # Array of used qubits, e.g., [0,1,2,3,7,8]
          "max_age": 1400
        }
        return request
...
if __name__ == '__main__':
    ...
    training_inputs, training_solutions = model.load_training_data(path="4000_samples_rotation_7_qubits")
    datasets_train, datasets_val = model.prepare_training_data(training_inputs, training_solutions, inputs_for_NN = "probability_for_each_state", split_indices=[[0,1,2,3], [4,5,6]])  # inputs for NN eiter register_probability_repeat or probability_for_each_state
