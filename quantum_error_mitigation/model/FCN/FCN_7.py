...
class Fully_connected_Neural_Network(Neural_Network_Base_Class):
    def __init__(self):
        ...
        self.linear1 = nn.Linear(self.num_input_nodes, num_hidden_neurons)
        self.linear2 = nn.Linear(num_hidden_neurons, num_hidden_neurons)
        self.linear3 = nn.Linear(num_hidden_neurons, self.num_output_nodes)
...
if __name__ == '__main__':
    ...
    datasets_train, datasets_val = model.prepare_training_data(training_inputs, training_solutions, inputs_for_NN = "probability_for_each_state")  # inputs for NN eiter register_probability_repeat or probability_for_each_state
