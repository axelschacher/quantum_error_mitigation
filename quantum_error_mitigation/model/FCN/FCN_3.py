...
class Fully_connected_Neural_Network(Neural_Network_Base_Class):
    def __init__(self):
        ...
        self.linear1 = nn.Linear(self.num_input_nodes, 16)
        self.linear2 = nn.Linear(16, 16)
        self.linear3 = nn.Linear(16, self.num_output_nodes)
    ...
    def generate_mitigation_service_request(self, counts, cm_gen_method):
        ...
        request = {
          ...
          "counts": counts,
          "shots": self.shots,
          "qubits": [0,1,2],  # Array of used qubits, e.g., [0,1,2,3,7,8]
          "max_age": 1400
        }
        return request
...
if __name__ == '__main__':
    ...
    training_inputs, training_solutions = model.load_training_data(path="4000_samples_rotation_3_qubits")
