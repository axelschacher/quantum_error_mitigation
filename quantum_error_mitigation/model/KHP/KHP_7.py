...
class K_most_frequent_Measurements_NN(Neural_Network_Base_Class):
    def __init__(self):
        ...
        self.num_input_nodes = 350
        self.num_output_nodes = 350
        self.linear1 = nn.Linear(self.num_input_nodes, 64)
        self.linear2 = nn.Linear(64, 64)
        self.linear3 = nn.Linear(64, self.num_output_nodes)
...
if __name__ == '__main__':
    ...
    datasets_train, datasets_val = model.prepare_training_data(training_inputs, training_solutions, inputs_for_NN = "k_most_frequent_states")  # inputs for NN eiter register_probability_repeat or probability_for_each_state or k_most_frequent_states
